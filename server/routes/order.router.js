...
router.get('/', (req, res) => {
  const orderQuery = `SELECT "orders"."id", "orders"."date", SUM("orders"."total_cost") AS "total_cost",  string_agg("status"."name", ',') "status",
  ...
  // `SELECT "orders"."id", "orders"."date", "orders"."total_cost", 
